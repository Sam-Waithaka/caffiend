...
export default function Stats(){
    ...
    const warningLevel = caffeineLevel < statusLevels['low'].maxLevel ? 'low' : 
        caffeineLevel < statusLevels['moderate'].max ? 'moderate'  : 'high'
    ...
    return (
        <>
            ...
            <div className="stats-grid">
                ...
                <StatCard title='Average # of coffess per day'>
                    <p><span className="stat-text">{stats.average_coffees}</span></p>
                </StatCard>

                <StatCard title='Daily costs ($)'>
                    <p>$ <span className="stat-text">{stats.daily_costs}</span></p>
                </StatCard>
